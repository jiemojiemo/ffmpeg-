...
//	char url[] = "F:/video/6s_kapian.mp4";
//
//	av_register_all();
...
//
//	//FIX:Some Codex's context Information is missing
...
int main(int argc, char* argv[])
{
	...
	FILE *pFile=fopen("Wildlife.wmv.pcm", "wb");
	char url[]="F:/video/Wildlife.wmv";
	...
	while(av_read_frame(pFormatCtx, packet)>=0){
		if(packet->stream_index==audioStream){
			...
			out_buffer_size=av_samples_get_buffer_size(NULL,out_channels ,pFrame->nb_samples,out_sample_fmt, 1);
			if ( got_picture > 0 ){
